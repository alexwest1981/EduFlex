TRUNCATE TABLE "tenant_saas_real_final".system_modules;

INSERT INTO "tenant_saas_real_final".system_modules (module_key, name, description, is_active, requires_license) VALUES 
