-- Fix constraints to allow user deletion
-- 1. Class groups should have mentor_id set to NULL if the user is deleted
ALTER TABLE class_groups DROP CONSTRAINT fk_class_groups_mentor;
...
ALTER TABLE class_wellbeing_surveys DROP CONSTRAINT class_wellbeing_surveys_student_id_fkey;
...
ALTER TABLE class_wellbeing_surveys DROP CONSTRAINT class_wellbeing_surveys_class_group_id_fkey;
