...
public class AIQuizController {
        ...
        public ResponseEntity<AIQuizGenerationResponse> generateFromFile(
                ...
                try {
                        ...
                        return ResponseEntity.internalServerError().body(
                                        AIQuizGenerationResponse.builder()
                                                        .success(false)
                                                        .errorMessage("Ett fel uppstod vid quiz-generering: "
                                                                        + e.getMessage())
                                                        .build());
                }
        }
        ...
        public ResponseEntity<AIQuizGenerationResponse> generateFromText(
                ...
                try {
                        ...
                        AIQuizGenerationResponse response = aiQuizGeneratorService.generateFromText(textContent,
                                        request);
                        return ResponseEntity.ok(response);
        ...
        public ResponseEntity<Map<String, Object>> deleteApiKey() {
                try {
                        ...
                        return ResponseEntity.ok(Map.of(
                                        "success", true,
                                        "message",
                                        "API-nyckel borttagen. Systemet använder nu miljövariabeln om den finns."));
                } catch (Exception e) {
        ...
        public ResponseEntity<AIQuizGenerationResponse> generatePracticeQuiz(
                ...
                try {
                        ...
                        AIQuizGenerationResponse response = aiQuizGeneratorService.generatePracticeQuiz(course,
                                        difficulty,
                                        questionCount);
                        return ResponseEntity.ok(response);
