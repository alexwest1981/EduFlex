...
const IntelligenceBar = ({ stats }) => (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
        {[
            { label: 'Kunskaps-k├Â', val: stats.queueSize, icon: Brain, color: 'text-brand-orange', bg: 'bg-brand-orange/10' },
                    ...
                    >
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                            <div className="flex-1">
                                <h2 className="text-4xl font-black mb-4 leading-tight">Dags f├Âr din <br /> Daily Review?</h2>
                                <p className="text-indigo-100 text-lg mb-8 font-medium leading-relaxed opacity-80">
                                    {stats.queueSize > 0
                                        ? `Du har ${stats.queueSize} koncept som v├ñntar p├Ñ din uppm├ñrksamhet. Optimera ditt minne med SM-2.`
                                        : 'Snyggt jobbat! Du har inga objekt som beh├Âver repeteras just nu.'}
                                </p>
            ...
            <div className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <MiniGameTile
                        ...
                        color="bg-purple-500"
                        xp="80"
                        description="Hitta matchande par mellan koncept och f├Ârklaringar."
                        delay={0.1}
                    />
                    <MiniGameTile
                        title="Time Attack"
                    ...
                    <MiniGameTile
                        ...
                        color="bg-red-500"
                        xp="500"
                        description="Utmanande test som t├ñcker hela din kurs."
                        delay={0.3}
                    />
                    <MiniGameTile
                        title="Flash Quiz"
                        ...
                        color="bg-amber-500"
                        xp="50"
                        description="Snabba slumpm├ñssiga fr├Ñgor f├Âr att h├Ñlla minnet fr├ñscht."
                        delay={0.4}
                    />
                </div>
            </div>
