...
import { Users, AlertCircle, FileText, CheckSquare } from 'lucide-react-native';
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <Text style={styles.greeting}>Hej {user?.firstName || 'Mentor'}!</Text>
                <Text style={styles.subtitle}>Mentorsöversikt</Text>
            </View>

            <View style={styles.alertCard}>
                <View style={styles.cardHeader}>
                    <AlertCircle color="#ff4444" size={24} />
                    <Text style={styles.alertCardTitle}>Hög Frånvaro</Text>
                </View>
                <Text style={styles.cardText}>
                    En av dina mentorselever, Kalle K., har &gt;15% frånvaro denna vecka. Notis skickad till Vårdnadshavare.
                </Text>
            </View>
            ...
            <View style={styles.statsRow}>
                <View style={styles.statBox}>
                    ...
                    <Text style={styles.statLabel}>Mentorselever</Text>
                </View>
                <View style={styles.statBox}>
                    <CheckSquare color="#aaa" size={20} />
                    <Text style={styles.statValue}>4</Text>
                    <Text style={styles.statLabel}>Åtgärdsplaner</Text>
                </View>
            </View>

            <Text style={styles.sectionTitle}>Mentorsverktyg</Text>
            <View style={styles.actionGrid}>
                <TouchableOpacity style={styles.actionItem}>
                    <View style={styles.actionIconContainer}><FileText color="#10b981" size={20} /></View>
                    <Text style={styles.actionText}>Utvecklingssamtal</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.actionItem}>
                    <View style={styles.actionIconContainer}><Users color="#10b981" size={20} /></View>
                    <Text style={styles.actionText}>Elevöversikt</Text>
                </TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
    ...
    actionText: { fontSize: 14, fontWeight: 'bold', color: '#fff', textAlign: 'center' },
});
